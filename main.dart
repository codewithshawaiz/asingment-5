...
void main() {
  stdout.write("Please Enter your credentials to View DATA \n");
  ...
  while (attemps < maxAttemp) {
    ...
    if (email == "shawaizali@gmail.com" && Password == "12345") {
      ...
      if (attemps == maxAttemp) {
        ...
        print(
            'Invalid Email and Password & Attempt left : $maxAttemp - $attemps');
